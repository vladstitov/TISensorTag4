...
(function (_ble) {
    var BLEConnector = (function () {
        ...
        BLEConnector.prototype.retrieveConnected = function (//iOS
            successCallback, errorCallback, params) {
        ...
        BLEConnector.prototype.characteristics = function (//iOS only
            successCallback, errorCallback, params) {
            this.ble.characteristics(successCallback, errorCallback, params);
        };
        BLEConnector.prototype.descriptors = function (//iOS only
            successCallback, errorCallback, params) {
        ...
        BLEConnector.prototype.subscribe = function (successCallback, //status": "subscribed"(no value) ,status": "subscribedResult",
        ...
        BLEConnector.prototype.write = function (//bluetoothle.bytesToEncodedString(bytes) to convert to base64 encoded string from a unit8Array.
            successCallback, errorCallback, params) {
